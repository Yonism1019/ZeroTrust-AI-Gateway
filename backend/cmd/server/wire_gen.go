...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	apiKeyService := service.NewAPIKeyService(apiKeyRepository, userRepository, groupRepository, userSubscriptionRepository, userGroupRateRepository, accountRepository, apiKeyCache, configConfig)
	...
	securityHandler := admin.NewSecurityHandler(securityService)
